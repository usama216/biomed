...
const Certifications = () => {
  ...
  return (
    <section className="bg-biomed-navy py-12 overflow-hidden">
          ...
          <div className="flex animate-marquee-slow hover:pause-marquee">
            ...
            {certificates.map((cert, idx) => (
              <div key={`cert-1-${idx}`} className="flex-shrink-0 mx-4">
                <div className="w-24 h-24 bg-white rounded-lg flex items-center justify-center shadow-lg p-2 transition-transform hover:scale-110">
                  <img 
                    src={cert} 
